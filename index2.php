...
<body class="hold-transition login-page" style="background:#E0E0E0">
    <div class="login-box">
        <!-- /.login-logo -->
        <div class="card"
            style="border-radius: 10px;border: 2px solid #000;background: #F4F4F4;box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25); height:530px; width:400px">
                ...
                <form class="px-3" method="POST" id="login_form">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="emp_no" name="emp_no" placeholder="Employee ID"
                            autocomplete="off" style="border-radius: 5px;border: 2px solid #000;background: #FFF;">
                    </div>
                    <div class="input-group mb-3">
