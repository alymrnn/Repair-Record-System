        ...
        <div class="modal-content" style="background:#f9f9f9;">
            <div class="modal-header" style="background:#407BA3;">
                <h5 class="modal-title" id="exampleModalLabel" style="font-weight: normal;color: #fff;"><i
                        class="fas fa-check-circle"></i>&nbsp;For Re-Assy / Re-Insert Verification</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <input type="text" id="line_no_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">

                        <!-- <select name="line_no_pdv_re_update" id="line_no_pdv_re_update" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                    ...
                    <div class="col-sm-2">
                        ...
                        <input list="categoryList" name="category_dr" id="line_category_pdv_re_update"
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="date" id="date_detected_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="date" id="repairing_date_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <input list="carMakerList" placeholder="Select the car maker" name="car_maker"
                            id="car_maker_pdv_re_update" onchange="handleCarMakerChange(this)" autocomplete="off"
                            style="border:1px solid #ced4da; color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                            class="pl-2">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="discovery_process_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-4">
                        <!-- discovery id number -->
                        <label style="font-weight: normal;color: #000;">ID Number <i>(Discovery)</i></label>
                        <input type="text" id="discovery_id_no_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-4">
                        <!-- discovery person -->
                        <label style="font-weight: normal;color: #000;">Discovery Person</label>
                        <input type="text" id="discovery_person_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input list="occurrenceShiftDrList" name="occurrence_shift_pdv_re_update"
                            id="occurrence_shift_pdv_re_update"
                            style="border:1px solid #ced4da; color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                            class="pl-2">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="occurrence_id_no_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-3">
                        <!-- occurrence person -->
                        <label style="font-weight: normal;color: #000;">Occurrence Person</label>
                        <input type="text" id="occurrence_person_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="outflow_process_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-3">
                        <!-- outflow shift -->
                        <label style="font-weight: normal;color: #000;">Outflow Shift</label>
                        <input list="outflowShiftDrList" name="outflow_shift_dr" id="outflow_shift_pdv_re_update"
                            style="border:1px solid #ced4da; color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                            class="pl-2">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="outflow_id_no_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-3">
                        <!-- outflow person -->
                        <label style="font-weight: normal;color: #000;">Outflow Person</label>
                        <input type="text" id="outflow_person_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="defect_category_pdv_dr_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-2">
                        <!-- sequence number -->
                        <label style="font-weight: normal;color: #000;">Sequence Number</label>
                        <input type="text" id="sequence_no_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-2">
                        <!-- assy board number -->
                        <label style="font-weight: normal;color: #000;">Assy Board Number</label>
                        <input type="text" id="assy_board_no_pdv_re_update" class="form-control pl-3" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                            required>
                    </div>
                    <div class="col-sm-2">
                        ...
                        <input list="defectCauseDrList" name="defect_cause_dr" id="defect_cause_pdv_re_update"
                            style="border:1px solid #ced4da; color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;"
                            class="pl-2">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" id="repair_person_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="wire_type_pdv_re_update" class="form-control pl-3" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-4">
                        <!-- wire size -->
                        <label style="font-weight: normal;color: #000;">Wire Size</label>
                        <input type="text" id="wire_size_pdv_re_update" class="form-control pl-3" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                    <div class="col-sm-4">
                        <!-- connector cavity -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <textarea type="text" id="detail_content_defect_pdv_re_update" class="textarea form-control"
                            autocomplete="off"
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea type="text" id="treatment_content_defect_pdv_re_update" class="form-control"
                            autocomplete="off"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="harness_status_pdv_re_update" class="form-control" autocomplete="off"
                            style="color: #525252;font-size: 15px;border-radius: .25rem;background: #FFF;height:34px; width:100%;">
                    </div>
                </div>
                ...
                <label class="mt-3" style="font-size: 20px"><b>For Re-Assy / Re-Insert</b></label>
                <div class="row">
                    <!-- reassy/reinsert -->
                    <div class="col-sm-3">
                        <label style="font-weight: normal;color: #000;">Remarks</label>
            ...
            <div class="modal-footer" style="background:#e9e9e9;">
                <div class="col-sm-2">
                    <!-- update button -->
                    <button class="btn btn-block" onclick="update_re_assy_record()"
