<div class="modal fade bd-example-modal-xl" id="update_car_settings" tabindex="-1" role="dialog" data-backdrop="static"
    data-keyboard="false">
            ...
            <div class="modal-body" style="max-height: 550px; overflow-y: auto;">
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" id="car_maker_qr_update" style="width: 100%; text-align: center;"
                            type="text">
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" id="car_value_qr_update" style="width: 100%; text-align: center;"
                            type="int">
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" id="pro_name_start_qr_update"
                            style="width: 100%; text-align: center;" type="int">
                    </div>
                    <div class="col-4">
                        <label style="font-weight: normal;">Product Name Length</label>
                        <input class="form-control" id="pro_name_length_qr_update"
                            style="width: 100%; text-align: center;" type="int">
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" id="lot_no_length_qr_update"
                            style="width: 100%; text-align: center;" type="int">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        ...
                        <input class="form-control" id="serial_no_start_qr_update"
                            style="width: 100%; text-align: center;" type="int">
                    </div>
                    <div class="col-6">
                        <label style="font-weight: normal;">Serial No. Length</label>
                        <input class="form-control" id="serial_no_length_qr_update"
                            style="width: 100%; text-align: center;" type="int">
                    </div>
                </div>
            </div>
