<div class="modal fade bd-example-modal-xl" id="add_repair_person" tabindex="-1" role="dialog" data-backdrop="static"
    data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="background:#f9f9f9;">
            ...
            <div class="modal-body" style="max-height: 550px; overflow-y: auto;">
                <div class="row">
                    <div class="col-4">
                        <label style="font-weight: normal;">Repair Person</label>
                        <input class="form-control" id="repair_person_d" style="width: 100%; text-align: center;" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer" style="background:#e9e9e9;">
                <div class="col-12">
                    ...
                    <div class="float-right">
                        <button class="btn btn-block" onclick="register_repair_person()"
