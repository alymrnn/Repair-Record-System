    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content" style="background:#e9e9e9;">
            ...
            <div class="modal-footer" style="background:#c2c2c2;">
                ...
                <div class="col-sm-2">
                    <button class="btn btn-block" onclick="add_mancost_only()" style="color:#fff;height:34px;border-radius:.25rem;background: #226F54;font-size:15px;font-weight:normal;">Add Record</button>
