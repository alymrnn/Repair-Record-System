        ...
        <div class="card-body">
          <div class="row mt-2">
            ...
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              ...
              <input type="text" id="search_product_name_new" class="form-control" placeholder="Product Name"
                autocomplete="off"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888;background: #FFF;height:34px; width:100%;"
                class="pl-3">
            </div>
            <div class="col-12 col-sm-6 col-md-2 mb-2">
              ...
              <input type="text" id="search_lot_no_new" class="form-control" placeholder="Lot No." autocomplete="off"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888;background: #FFF;height:34px; width:100%;"
                class="pl-3">
            </div>
            <div class="col-12 col-sm-6 col-md-2 mb-2">
            ...
            <div class="col-12 col-sm-2">
              ...
              <button class="btn btn-block d-flex justify-content-left" id="search_record_btn"
                onclick="load_defect_table_new_record(1)"
          ...
          <div class="row">
            <div class="col-12 col-sm-2">
              ...
              <select name="search_record_type_new" id="search_record_type_new" autocomplete="off"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888;background: #FFF;height:34px; width:100%;"
            ...
            <div class="col-12 col-sm-2">
              ...
              <input type="text" id="search_line_no_new" class="form-control" placeholder="Line no." autocomplete="off"
                style="color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #888;background: #FFF;height:34px; width:100%;"
                class="pl-3">
            </div>
            <div class="col-12 col-sm-2">
          ...
          <div id="list_of_defect_qa_res" class="card-body mt-4 table-responsive m-0 p-0" style="max-height: 400px;">
            <table class="table col-12 table-head-fixed text-nowrap table-hover" id="defect_qa_table"
              ...
              <tbody class=" m-0 p-0" id="list_of_defect_record_new">
                <tr>
