<script type="text/javascript">
    ...
    const clear_search_input_pdv = () => {
        ...
        document.getElementById("search_car_maker_pdv_re").value = '';
    ...
    function get_update_defect_re_assy(dataString) {
        ...
        $('#car_model_pdv_re_update').val(data[2]).prop('disabled', true).css('background', '#EEE');
        $('#line_no_pdv_re_update').val(data[3]).prop('disabled', true).css('background', '#EEE');
        $('#line_category_pdv_re_update').val(data[4]).prop('disabled', true).css('background', '#EEE');
        $('#date_detected_pdv_re_update').val(data[5]).prop('disabled', true).css('background', '#EEE');
        $('#issue_tag_pdv_re_update').val(data[6]).prop('disabled', true).css('background', '#EEE');
        $('#repairing_date_pdv_re_update').val(data[7]).prop('disabled', true).css('background', '#EEE');
        $('#product_name_pdv_re_update').val(data[8]).prop('disabled', true).css('background', '#EEE');
        $('#lot_no_pdv_re_update').val(data[9]).prop('disabled', true).css('background', '#EEE');
        $('#serial_no_pdv_re_update').val(data[10]).prop('disabled', true).css('background', '#EEE');
        $('#discovery_process_pdv_re_update').val(data[11]).prop('disabled', true).css('background', '#EEE');
        $('#discovery_id_no_pdv_re_update').val(data[12]).prop('disabled', true).css('background', '#EEE');
        $('#discovery_person_pdv_re_update').val(data[13]).prop('disabled', true).css('background', '#EEE');
        $('#occurrence_process_pdv_dr_re_update').val(data[14]).prop('disabled', true).css('background', '#EEE');
        $('#occurrence_shift_pdv_re_update').val(data[15]).prop('disabled', true).css('background', '#EEE');
        $('#occurrence_id_no_pdv_re_update').val(data[16]).prop('disabled', true).css('background', '#EEE');
        $('#occurrence_person_pdv_re_update').val(data[17]).prop('disabled', true).css('background', '#EEE');
        $('#outflow_process_pdv_re_update').val(data[18]).prop('disabled', true).css('background', '#EEE');
        $('#outflow_shift_pdv_re_update').val(data[19]).prop('disabled', true).css('background', '#EEE');
        $('#outflow_id_no_pdv_re_update').val(data[20]).prop('disabled', true).css('background', '#EEE');
        $('#outflow_person_pdv_re_update').val(data[21]).prop('disabled', true).css('background', '#EEE');
        $('#defect_category_pdv_dr_re_update').val(data[22]).prop('disabled', true).css('background', '#EEE');
        $('#sequence_no_pdv_re_update').val(data[23]).prop('disabled', true).css('background', '#EEE');
        $('#assy_board_no_pdv_re_update').val(data[24]).prop('disabled', true).css('background', '#EEE');
        $('#defect_cause_pdv_re_update').val(data[25]).prop('disabled', true).css('background', '#EEE');
        $('#good_measurement_pdv_re_update').val(data[26]).prop('disabled', true).css('background', '#EEE');
        $('#ng_measurement_pdv_re_update').val(data[27]).prop('disabled', true).css('background', '#EEE');
        $('#wire_type_pdv_re_update').val(data[28]).prop('disabled', true).css('background', '#EEE');
        $('#wire_size_pdv_re_update').val(data[29]).prop('disabled', true).css('background', '#EEE');
        $('#connector_cavity_pdv_re_update').val(data[30]).prop('disabled', true).css('background', '#EEE');
        $('#repair_person_pdv_re_update').val(data[31]).prop('disabled', true).css('background', '#EEE');
        $('#detail_content_defect_pdv_re_update').val(data[32]).prop('disabled', true).css('background', '#EEE');
        $('#treatment_content_defect_pdv_re_update').val(data[33]).prop('disabled', true).css('background', '#EEE');
        $('#harness_status_pdv_re_update').val(data[34]).prop('disabled', true).css('background', '#EEE');

        $('#cc_remarks_1_re_update').val(data[35]);
        $('#cc_remarks_2_re_update').val(data[36]);
        $('#cc_id_no_re_update').val(data[37]);
        $('#cc_name_re_update').val(data[38]);

        $('#recrimp_remarks_re_update').val(data[39]);
        $('#recrimp_pd_id_no_re_update').val(data[40]);
        $('#recrimp_pd_name_re_update').val(data[41]);
        $('#recrimp_qa_id_no_re_update').val(data[42]);
        $('#recrimp_qa_name_re_update').val(data[43]);

        $('#admin_defect_id_4').val(data[44]).prop('hidden', true);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response == 'success') {
                    ...
                    var reassy_remarks = $('#reassy_remarks_re_update').val();

                    if (reassy_remarks === 'NO GOOD') {
