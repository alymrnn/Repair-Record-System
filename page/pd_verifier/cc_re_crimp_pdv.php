...
<?php include 'plugins/sidebar/cc_re_crimp_pdv_bar.php'; ?>
...
<div class="content-wrapper" style="background: #FFF;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">For Counterpart Checking and Re-crimp</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="defect_monitoring_record_rp.php">Repair Record System</a>
                        </li>
                        <li class="breadcrumb-item active">For Counterpart Checking and Re-crimp</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-light" style="background: #fff; border-top: 1px solid #0069B0;">
                <div class="card-header">
                    <h3 class="card-title"><img src="../../dist/img/settings.png" style="height:28px;">
                        &ensp;For Counterpart Checking and Re-crimp Monitoring Table</h3>
...
<?php include 'plugins/js/cc_re_crimp_pdv_script.php'; ?>