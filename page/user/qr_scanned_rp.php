...
<?php include 'plugins/sidebar/qr_scanned_rp_bar.php'; ?>
...
<div class="content-wrapper" style="background: #FFF;">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">List of Scanned QR-Code</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="defect_monitoring_record_rp.php">Repair Record System</a></li>
            <li class="breadcrumb-item active">List of Scanned QR-Code</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<?php include 'plugins/js/qr_scanned_rp_script.php'; ?>