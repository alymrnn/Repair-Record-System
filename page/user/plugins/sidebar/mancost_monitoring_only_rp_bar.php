<aside class="main-sidebar sidebar-light-primary elevation-2" style="background: #F6F6F6;">
  <!-- Brand Logo -->
  <a href="qr_scanning.php" class="brand-link">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="qr_scanning.php" class="d-block" style="font-size:16px; color:black"><?= htmlspecialchars($_SESSION['full_name']); ?></a>
      </div>
    </div>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="defect_monitoring_record_rp.php" class="nav-link">
            <img src="../../dist/img/folder.png" style="height:25px;">
            <p class="pl-1" style="font-size:16px; color:black">
        ...
        <li class="nav-item">
          <a href="mancost_monitoring_only_rp.php" class="nav-link active">
