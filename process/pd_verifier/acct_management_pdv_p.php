...
{
    $query = "SELECT count(id) AS total FROM m_accounts WHERE role = 'PD Verifier' AND emp_no LIKE '" . $search_arr['emp_no_search'] . "%' AND full_name LIKE '" . $search_arr['full_name_search'] . "%'";
